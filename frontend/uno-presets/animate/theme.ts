...
export const theme: Theme = {
  animation: {
    ...
    durations: {
      ...
      "accordion-down": "var(--un-animation-duration, var(--un-duration, 200ms))",
      "accordion-up": "var(--un-animation-duration, var(--un-duration, 200ms))",
      "collapsible-down": "var(--un-animation-duration, var(--un-duration, 200ms))",
      "collapsible-up": "var(--un-animation-duration, var(--un-duration, 200ms))",
      "caret-blink": "1.25s",
    },
    timingFns: {
      in: "var(--un-ease, ease)",
